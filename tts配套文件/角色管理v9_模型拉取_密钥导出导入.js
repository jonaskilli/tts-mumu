   ...
   currentTestResultPopup.showAtLocation(anchor, android.view.Gravity.TOP | android.view.Gravity.CENTER_HORIZONTAL, 0, yOffset);
            ...
            for (var i = 0; i < kl.list.length; i++) {
                (function(name, keyItem, isCurrent, keyIdx) {
                    ...
                    var viewEditBtn = createSmallButton("✎", "#1976D2", true);
            ...
            var addBtn = createBottomBtn("＋ 新增密钥", "#1976D2");
        ...
        function showModelSelectDialog(baseUrl, apiKey, models) {
            ...
            function rebuildList() {
                ...
                for (var g = 0; g < groupOrder.length; g++) {
                    ...
                    groupTitle.setTextColor(android.graphics.Color.parseColor("#1976D2"));
