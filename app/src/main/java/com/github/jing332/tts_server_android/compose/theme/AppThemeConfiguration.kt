...
fun emeraldTheme(
    ...
    if (!darkTheme)
        lightColorScheme(
            primary = emerald_seed,
            onPrimary = emerald_md_theme_light_onPrimary,
            primaryContainer = emerald_md_theme_light_primaryContainer,
            onPrimaryContainer = emerald_md_theme_light_onPrimaryContainer,
            secondary = emerald_md_theme_light_secondary,
            onSecondary = emerald_md_theme_light_onSecondary,
            secondaryContainer = emerald_md_theme_light_secondaryContainer,
            onSecondaryContainer = emerald_md_theme_light_onSecondaryContainer,
            tertiary = emerald_md_theme_light_tertiary,
            onTertiary = emerald_md_theme_light_onTertiary,
            tertiaryContainer = emerald_md_theme_light_tertiaryContainer,
            onTertiaryContainer = emerald_md_theme_light_onTertiaryContainer,
            error = emerald_md_theme_light_error,
            errorContainer = emerald_md_theme_light_errorContainer,
            onError = emerald_md_theme_light_onError,
            onErrorContainer = emerald_md_theme_light_onErrorContainer,
            background = emerald_md_theme_light_background,
            onBackground = emerald_md_theme_light_onBackground,
            outline = emerald_md_theme_light_outline,
            inverseOnSurface = emerald_md_theme_light_inverseOnSurface,
            inverseSurface = emerald_md_theme_light_inverseSurface,
            inversePrimary = emerald_md_theme_light_inversePrimary,
            surfaceTint = emerald_md_theme_light_surfaceTint,
            outlineVariant = emerald_md_theme_light_outlineVariant,
            scrim = emerald_md_theme_light_scrim,
            surface = emerald_md_theme_light_surface,
            onSurface = emerald_md_theme_light_onSurface,
            surfaceVariant = emerald_md_theme_light_surfaceVariant,
            onSurfaceVariant = emerald_md_theme_light_onSurfaceVariant,
        )
    else
        darkColorScheme(
            primary = emerald_md_theme_dark_primary,
            onPrimary = emerald_md_theme_dark_onPrimary,
            primaryContainer = emerald_md_theme_dark_primaryContainer,
            onPrimaryContainer = emerald_md_theme_dark_onPrimaryContainer,
            secondary = emerald_md_theme_dark_secondary,
            onSecondary = emerald_md_theme_dark_onSecondary,
            secondaryContainer = emerald_md_theme_dark_secondaryContainer,
            onSecondaryContainer = emerald_md_theme_dark_onSecondaryContainer,
            tertiary = emerald_md_theme_dark_tertiary,
            onTertiary = emerald_md_theme_dark_onTertiary,
            tertiaryContainer = emerald_md_theme_dark_tertiaryContainer,
            onTertiaryContainer = emerald_md_theme_dark_onTertiaryContainer,
            error = emerald_md_theme_dark_error,
            errorContainer = emerald_md_theme_dark_errorContainer,
            onError = emerald_md_theme_dark_onError,
            onErrorContainer = emerald_md_theme_dark_onErrorContainer,
            background = emerald_md_theme_dark_background,
            onBackground = emerald_md_theme_dark_onBackground,
            outline = emerald_md_theme_dark_outline,
            inverseOnSurface = emerald_md_theme_dark_inverseOnSurface,
            inverseSurface = emerald_md_theme_dark_inverseSurface,
            inversePrimary = emerald_md_theme_dark_inversePrimary,
            surfaceTint = emerald_md_theme_dark_surfaceTint,
            outlineVariant = emerald_md_theme_dark_outlineVariant,
            scrim = emerald_md_theme_dark_scrim,
            surface = emerald_md_theme_dark_surface,
            onSurface = emerald_md_theme_dark_onSurface,
            surfaceVariant = emerald_md_theme_dark_surfaceVariant,
            onSurfaceVariant = emerald_md_theme_dark_onSurfaceVariant,
        )
