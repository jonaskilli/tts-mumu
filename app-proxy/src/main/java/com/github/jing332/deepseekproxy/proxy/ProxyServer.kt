...
object ProxyServer {
    ...
    /** 识别为智谱（GLM）文本模型的名称（前缀匹配，大小写不敏感）。免登录。 */
    private val ZHIPU_MODELS = listOf("gml", "glm", "zhipu")

    /** 识别为智谱生图模型的名称（精确/前缀匹配，大小写不敏感）。免登录。 */
                ...
                get("/v1/models") {
                    call.respond(
                        mapOf(
                            "object" to "list",
                            "data" to listOf(
                                mapOf("id" to CnbClient.DEFAULT_MODEL, "object" to "model", "owned_by" to "cnb"),
                                mapOf("id" to "doubao", "object" to "model", "owned_by" to "doubao"),
                                mapOf("id" to "doubao-think", "object" to "model", "owned_by" to "doubao"),
                                mapOf("id" to "doubao-auto", "object" to "model", "owned_by" to "doubao"),
                                mapOf("id" to "doubao-expert", "object" to "model", "owned_by" to "doubao"),
                                mapOf("id" to "doubao-pro", "object" to "model", "owned_by" to "doubao"),
                                mapOf("id" to "kimi", "object" to "model", "owned_by" to "kimi"),
                                mapOf("id" to "qwen", "object" to "model", "owned_by" to "qwen"),
                                mapOf("id" to "qwen-think", "object" to "model", "owned_by" to "qwen"),
                                mapOf("id" to "deepseek", "object" to "model", "owned_by" to "deepseek"),
                                mapOf("id" to "deepseek-chat", "object" to "model", "owned_by" to "deepseek"),
                                mapOf("id" to "gml", "object" to "model", "owned_by" to "zhipu"),
                                mapOf("id" to "gml-plus", "object" to "model", "owned_by" to "zhipu"),
                                mapOf("id" to "智谱生图", "object" to "model", "owned_by" to "zhipu"),
                                mapOf("id" to "deepseek-pro", "object" to "model", "owned_by" to "deepseek"),
                                mapOf("id" to "longcat", "object" to "model", "owned_by" to "longcat"),
                                mapOf("id" to "longcat-search", "object" to "model", "owned_by" to "longcat")
                            )
                        )
                    )
                }
    ...
    private suspend fun RoutingContext.handleImageGen() {
        try {
            ...
            // 智谱生图（免登录）：model 名命中智谱生图 → 走智谱，只返回第一张
